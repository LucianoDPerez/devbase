...
`v0.15.x`: setup interactivo, 25 packs de reglas, gate estricto con evidencia JSON (suites del proyecto + build + Semgrep + E2E condicional), instaladores con checksum, CI con tests + Semgrep + batería E2E permanente.
