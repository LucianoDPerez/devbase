...
`v0.15.x`: interactive setup, 25 rule packs, strict gate with JSON evidence (project suites + build + Semgrep + conditional E2E), checksum installers, CI with tests + Semgrep + always-on E2E battery.
