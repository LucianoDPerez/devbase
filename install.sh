...
echo ""
echo "next steps — run these INSIDE your project folder:"
echo "  cd /path/to/your/project"
echo "  devbase init --dir .                 # write contextual rules to .devbase/"
echo "  devbase init --dir . --wire          # also configure your detected IDEs"
echo "  devbase gate --dir .                 # verify with evidence"
echo ""
echo "Each detected IDE (Cursor, VS Code, Claude Code, OpenCode...) is wired"
echo "automatically by --wire. Restart your IDE afterwards so it picks up the config."
